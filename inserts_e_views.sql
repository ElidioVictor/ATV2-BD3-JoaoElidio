...
create view dados_aluno 
as
select 	aluno.nome, aluno.tel_aluno, 
...
create view turma_materia 
as
select 	disc.sigla as materias, 
		turma.sigla as turma, 
        turma.nome as nome_turma
from tb_disciplina disc 
inner join tb_turma turma on turma.id_turma = disc.id_turma;
